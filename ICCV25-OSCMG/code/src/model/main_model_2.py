...
class Semantic_Decoder(nn.Module):
    ...
    def forward(self, input_vq):
        ...
        return class_logits, input_feat
...
class AVT_VQVAE_Encoder(nn.Module):
    ...
    def Audio_VQ_Encoder(self, audio_feat):
        ...
        audio_vq, indices = self.Cross_quantizer.rq_embedding_indices(audio_semantic_result)
        return audio_vq, indices
    ...
    def Video_VQ_Encoder(self, video_feat):
        ...
        video_vq, indices = self.Cross_quantizer.rq_embedding_indices(video_semantic_result)
        return video_vq, indices
...
class Cross_VQEmbeddingEMA_AVT(nn.Module):
    ...
    def rq_embedding_indices(self, semantic, beam_size=1):
        assert beam_size >= 1
        self.embedding[0] = 0
        if beam_size == 1:
            """residual_quantize"""
            ...
            return aggregated_quants, indice_list

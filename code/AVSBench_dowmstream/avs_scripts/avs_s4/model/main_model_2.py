...
class Semantic_Decoder(nn.Module):
    def __init__(self, input_dim, class_num):""" class_num AVE:28  VGGSOUND:141  UCF_VGGSOUND:16 """
...
class Semantic_Decoder_AVVP(nn.Module):
    def __init__(self, input_dim, class_num):""" class_num AVVP:25+1(negative label) AVE_AVVP:12+1 """
